...
public class TC002_ServicesSection extends BaseClass {
	...
	public void HomeImage_compare() throws IOException, InterruptedException, Exception{
		BufferedImage expectedImage1 = ImageIO.read(new File(
				"C:\\Users\\Senthilnathan\\workspace\\" + "GrootanTechnology\\Screenshots\\Folder1\\ServicePage.png"));
		BufferedImage actualImage1 = ImageIO.read(new File(
				"C:\\Users\\Senthilnathan\\workspace\\" + "GrootanTechnology\\Screenshots\\Folder2\\ServicePage.png"));
